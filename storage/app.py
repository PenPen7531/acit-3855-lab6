...
def process_messages():
    ...
    while try_count <= app_config['kafka']['retries']:
        ...
        try:
            ...
            consumer = topic.get_balanced_consumer(consumer_group=b'event_group',reset_offset_on_start=False, auto_commit_enabled=True, auto_commit_interval_ms=100, zookeeper_connect="http://zookeeper:9092")
